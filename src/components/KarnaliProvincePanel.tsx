...
export function KarnaliProvincePanel() {
  ...
  const genderSlices = rowsToSlices(karnaliGender2021 as unknown as Record<string, number>, [
    KARNALI_CHART_COLORS.blue,
    KARNALI_CHART_COLORS.orange,
  ])
  const ageSlices = rowsToSlices(karnaliBroadAge2021 as unknown as Record<string, number>, [
    KARNALI_CHART_COLORS.blue,
    KARNALI_CHART_COLORS.green,
    KARNALI_CHART_COLORS.orange,
  ])
  const citSlices = rowsToSlices(karnaliCitizenship2021 as unknown as Record<string, number>, [
    KARNALI_CHART_COLORS.blue,
    KARNALI_CHART_COLORS.orange,
    KARNALI_CHART_COLORS.slate,
  ])
  const birthSlices = rowsToSlices(karnaliPlaceOfBirth2021 as unknown as Record<string, number>, [
    KARNALI_CHART_COLORS.blue,
    KARNALI_CHART_COLORS.green,
    KARNALI_CHART_COLORS.orange,
    KARNALI_CHART_COLORS.red,
  ])
  const litSlices = rowsToSlices(karnaliLiteracyAge5Plus2021 as unknown as Record<string, number>, [
    KARNALI_CHART_COLORS.green,
    KARNALI_CHART_COLORS.cyan,
    KARNALI_CHART_COLORS.orange,
  ])
